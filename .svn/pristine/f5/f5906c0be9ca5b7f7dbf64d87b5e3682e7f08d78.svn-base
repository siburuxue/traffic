...
window.onload = function () {
    ...
    $( "#scrollBed .viewInfo-box:eq("+ currentChartType +")" ).trigger( "click" );
...
function initChartsTypeView () {
    ...
    for ( var i = 0, len = chartsConfig.length; i<len; i++ ) {
        ...
        contents.push( '<div class="viewInfo-box" data-chart-type="'+ i +'"><img width="300" src="images/charts'+ i +'.png"></div>' );
...
function initEvent () {
    ...
    var cacheValue = null,
        ...
        $chartsTypeViewBox = $( '#scrollBed .viewInfo-box' );
    ...
    $( ".table-viewInfo" ).delegate( ".data-item", "focus", function () {
    ...
    //图表类型变化
    $( '#scrollBed' ).delegate( ".viewInfo-box", "click", function (e) {
