 ...
 * 复核 审核
 */
class CaseReviewCheckHandleController extends CommonController {
	/**
	 * 首页
	 */
	public function index() {
		...
		if (empty($caseReviewCheck)) {
			$this->success('新增', U('add?case_review_id=' . $caseReviewId));
			// $this->redirect('add', array('case_review_id' => $caseReviewId));
		} else {
			$this->success('编辑', U('edit?case_review_id=' . $caseReviewId));
