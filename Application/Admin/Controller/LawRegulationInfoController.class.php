 ...
 * 法律法规
 */
class LawRegulationInfoController extends CommonController {
    private $array = array();
    /**
     * 首页界面
     */
    ...
    public function indexTable(){
        ...
        $this->display("LawRegulationInfo/index/table");
    }
    ...
    public function viewFileTable(){
        ...
        $this->assign('list',$list);
        $this->display('LawRegulationInfo/view/table');
    }
    ...
    public function viewAllTable(){
        ...
        $this->assign('list',$list);
        $this->display('LawRegulationInfo/view/allTable');
    }
