...
<body>
    ...
    <?php if(is_power($myPower,'leader_return')): ?><li class="active"><a href="<?php echo U('CaseClientDetainSupervisor/pending');?>">物品返还</a></li><?php endif; ?>
    ...
    <table class="table table-bordered table-condensed table-form">
        ...
        <tr>
            <th>所属大队</th>
            <?php if(is_power($myPower,'case_client_detain_supervisor_2')): ?><td>
            ...
            <?php if(is_power($myPower,'case_client_detain_supervisor_2')): ?><td>
                ...
                <?php else: ?>
                <?php if(is_power($myPower,'case_client_detain_supervisor_1')): ?><td>
...
<div class="container-fluid" id="approval-box" style="display:none;margin-top:20px;">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseClientDetainSupervisor/pending.js"></script>
