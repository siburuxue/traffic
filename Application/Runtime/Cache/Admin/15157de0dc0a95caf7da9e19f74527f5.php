...
<body>
	...
	<?php if(is_power($myPower,'case_pending')): ?><li class="active"><a href="<?php echo U('CaseHandle/pending');?>">待办工作</a></li><?php endif; ?>
...
<div style="margin-bottom:20px;">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseHandle/pending.js"></script>
