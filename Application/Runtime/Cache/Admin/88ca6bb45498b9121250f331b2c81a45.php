...
<body>
    ...
    <?php if(is_power($myPower,'leader_bloodtube_search')): ?><li class="active"><a href="<?php echo U('CaseBloodtubeCateSearchSupervisor/index');?>">采血管查询</a></li><?php endif; ?>
    <?php if(is_power($myPower,'leader_account')): ?><li class="active"><a href="<?php echo U('CaseStandingBook/index?type=leader');?>">交通事故台帐</a></li><?php endif; ?>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-condensed table-custom">
                <tr>
                    <?php if(is_power($myPower,'case_bloodtubecate_supervisor_advance')): ?><th>被派发大队</th>
                        <td>
                        ...
                        <th>被派发大队</th>
                        <td>
                            <input type="hidden" name="condition_target_department_id" value="<?php echo ($myBrigade["id"]); ?>" class="form-control input-sm search-auto">
                            <input type="text" name="condition_target_department_id" value="<?php echo ($myBrigade["name"]); ?>" class="form-control input-sm " readOnly="readOnly" style="width:100%;">
                        </td>
                        <th>被派发办案人</th>
                        <td>
                            <?php if(is_power($myPower,'case_bloodtubecate_supervisor_normal')): ?><select name="condition_target_user_id" class="form-control input-sm search-auto" style="width:100%;">
                                    <option value="">请选择</option>
                                ...
                                <?php else: ?>
                                <input type="hidden" name="condition_target_user_id" value="<?php echo ($my['id']); ?>" class="form-control input-sm search-auto">
                                <input type="text" name="condition_target_user_id" value="<?php echo ($my['true_name']); ?>" class="form-control input-sm" readOnly="readOnly"><?php endif; ?>
                        </td><?php endif; ?>
                </tr>
                <tr>
                    <th width="15%">派发时间</th>
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseBloodtubeCateSearchSupervisor/index.js"></script>
