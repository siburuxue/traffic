...
<body>
	...
	<?php if(is_power($myPower,'case_completed')): ?><li class="active"><a href="<?php echo U('CaseHandle/completed');?>">已完成工作</a></li><?php endif; ?>
...
<div style="margin-bottom:20px;">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseHandle/completed.js"></script>
