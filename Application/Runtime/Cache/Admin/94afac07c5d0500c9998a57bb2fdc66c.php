...
<head>
    ...
    // 定义URL地址
    url.table = "<?php echo U('bloodtubeTable');?>";
    ...
    <div class="container-fluid main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">血样提取统计</span></div>
...
<div class="panel panel-default" style="position:absolute;z-index:9999;display:none;" id="select-handle">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/Statistics/bloodtube.js"></script>
