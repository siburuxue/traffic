...
<body>
    ...
    <div class="container-fluid main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">组别列表</span></div>
    ...
    <div class="panel-body ">
        <div class="table-responsive">
            <table class="table table-bordered table-condensed table-custom">
                <tr>
                    <?php if(is_power($myPower,'duty_advance')): ?><th>大队</th>
                        <td>
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/DutyGroup/index.js"></script>
