...
<head>
    ...
    url.getTypeChild = "<?php echo U('getTypeChild');?>";
    </script>
...
<ul class="nav nav-tabs nav-custom">
	<?php if(is_power($myPower,'checkup_pending')): ?><li class="active"><a href="<?php echo U('index');?>">待办工作</a></li><?php endif; ?>
	<?php if(is_power($myPower,'checkup_completed')): ?><li><a href="<?php echo U('finish');?>">已完成工作</a></li><?php endif; ?>
</ul>
        ...
        <tr>
            ...
            <td>
                <select name="condition_checkup_org_item_pid" id="checkup_org_item_pid" class="form-control input-sm search-auto" style="width:50%;float:left;">
                    <option value="">请选择</option>
                    <?php if(is_array($case_checkup_obj_type)): foreach($case_checkup_obj_type as $key=>$vo): ?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                </select>
...
<div style="margin-bottom:20px;">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseCheckupDetachment/index.js"></script>
