...
<body>
    ...
    <div class="container-fluid main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">值班列表</span></div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-condensed table-custom">
            <tr>
                ...
                <th width="15%">值班人</th>
                <td width="35%">
                    <input type="text" class="form-control input-sm search-auto" name="condition_true_name" maxlength="255" style="width:100%;">
                </td>
            </tr>
            <tr>
                <th>值班组别</th>
                <td <?php if(is_power($myPower,'duty_advance') == false ): ?>colspan="3"<?php endif; ?>>
                    <select name="condition_duty_group_id" class="form-control input-sm search-auto" style="width:100%;">
                        <option value="">请选择</option>
                        <?php if(is_array($dutyGroupType)): foreach($dutyGroupType as $key=>$vo): ?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
                    </select>
                </td>
                <?php if(is_power($myPower,'duty_advance')): ?><th width="160">大队</th>
                    <td>
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/Duty/index.js"></script>
