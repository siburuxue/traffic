...
<head>
    ...
    url.cancelAttention = "<?php echo U('cancelAttention');?>";
    </script>
    ...
    <div class="container-fluid main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">已关注案件</span></div>
...
<div style="margin-bottom:20px;">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right" style="padding-right:0px;">
                            <button type="button" class="btn btn-sm btn-primary" id="attention"><span class="glyphicon glyphicon-remove-circle"></span> 取消关注</button>
                            <a href="<?php echo U('CaseAttention/pending');?>" class="btn btn-primary btn-sm js-open js-end-refresh"><span class="glyphicon glyphicon-plus"></span> 新增关注</a>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseAttention/completed.js"></script>
