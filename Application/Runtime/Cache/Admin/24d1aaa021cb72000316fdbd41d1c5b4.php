...
<body>
	...
	<?php if(is_power($myPower,'review_pending')): ?><li class="active"><a href="javascript:;">待办工作</a></li><?php endif; ?>
	<?php if(is_power($myPower,'review_completed')): ?><li><a href="<?php echo U('CaseReviewHandle/completed');?>">已完成工作</a></li><?php endif; ?>
</ul>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="<?php echo U('search');?>" class="btn btn-primary btn-sm js-open js-end-refresh"><span class="glyphicon glyphicon-plus"></span> 受理复核</a>
...
<div style="margin-bottom:20px;">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseReviewHandle/pending.js"></script>
