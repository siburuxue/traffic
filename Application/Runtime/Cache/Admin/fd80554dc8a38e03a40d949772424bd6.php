...
<head>
    ...
    <script type="text/javascript">
        // 定义URL地址
        url.table = "<?php echo U('voidTable');?>";
    </script>
...
<body>
    ...
    <div class="container-fluid main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">已作废检验鉴定机构</span></div>
                </div>
            </div>
            <!-- 面板主体 -->
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CheckupOrg/void.js"></script>
