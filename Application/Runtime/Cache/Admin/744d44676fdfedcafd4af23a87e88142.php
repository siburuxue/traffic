...
<body>
	...
	<?php if(is_power($myPower,'leader_my_work')): ?><li class="active"><a href="<?php echo U('CaseCheckLeader/pending');?>">待办工作</a></li>
	...
	<?php if(is_power($myPower,'leader_account')): ?><li class="active"><a href="<?php echo U('CaseStandingBook/index?type=leader');?>">交通事故台帐</a></li><?php endif; ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">待办案件列表</span></div>
                </div>
            </div>
            <!-- 面板主体 -->
    ...
    <tr>
        <th width="15%">案件编号</th>
        <td width="35%">
            <input type="text" class="form-control input-sm search-auto" name="condition_code" maxlength="50">
        </td>
        <th width="15%">当前状态</th>
        <td>
            <select name="condition_cate" class="form-control input-sm search-auto">
                <option value="">请选择</option>
                <?php if(is_array($checkType)): $i = 0; $__LIST__ = $checkType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <select name="condition_department_id" class="form-control input-sm search-auto">
                <option value="">请选择</option>
                <?php if(is_array($departmentList)): $i = 0; $__LIST__ = $departmentList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <input type="text" class="form-control input-sm search-auto form-datetime" id="condition_start_name"  name="condition_start_name" maxlength="255" readonly style="min-width:auto!important;width:19.7%;display: inline-block">
            ~
            <input type="text" class="form-control input-sm search-auto form-datetime" id="condition_end_name" name="condition_end_name" maxlength="255" readonly style="min-width:auto!important;width:19.7%;display: inline-block">
        </td>
    </tr>
</table>
<div style="margin-bottom: 20px;">
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/CaseCheckLeader/pending.js"></script>
