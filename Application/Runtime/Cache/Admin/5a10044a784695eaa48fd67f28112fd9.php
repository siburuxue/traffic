...
<body>
    ...
    <div class="container-fluid main">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6"><span class="block-title">其他法律法规</span></div>
                    <div class="col-xs-6 text-right">
                        <a href="<?php echo U('addFolder');?>" id="add-folder" class="btn btn-primary btn-sm js-open js-end-refresh"><span class="glyphicon glyphicon-plus"></span> 新增文件夹</a>
    ...
    <script type="text/javascript" src="<?php echo (SRC_MODULE_URL); ?>/js/LawRegulation/index.js"></script>
