...
//		echo '<br />';
	...
	private function _readWindow2()
	{
		...
		if ($this->_version === self::XLS_BIFF8) {
			...
			// offset: 12; size: 2; cached magnification factor in normal viewInfo (in percent); 0 = Default (100%)
		...
		// bit: 11; mask: 0x0800; 0 = normal viewInfo, 1 = page break viewInfo
		$isPageBreakPreview = (bool) ((0x0800 & $options) >> 11);

		//FIXME: set $firstVisibleRow and $firstVisibleColumn

		if ($this->_phpSheet->getSheetView()->getView() !== PHPExcel_Worksheet_SheetView::SHEETVIEW_PAGE_LAYOUT) {
			//NOTE: this setting is inferior to page layout viewInfo(Excel2007-)
	...
	private function _readScl()
	{
		...
		// offset: 0; size: 2; numerator of the viewInfo magnification
		$numerator = self::_GetInt2d($recordData, 0);

		// offset: 2; size: 2; numerator of the viewInfo magnification
